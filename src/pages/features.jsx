  ...
  const features = [
    {
      ...
      description:
        "Efficiently manage student records, attendance tracking, and academic progress monitoring.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Create and manage courses, assignments, and learning materials with ease.",
      benefits: [
        "Curriculum planning",
    ...
    },
    {
      ...
      title: "Scheduling",
      description:
        "Streamline class scheduling, exam timetables, and faculty assignments.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Handle fee collection, generate invoices, and track payments efficiently.",
    ...
    },
    {
      ...
      title: "Security",
      description:
        "Ensure data protection with advanced security features and role-based access.",
    ...
    },
    {
      ...
      title: "Communication",
      description:
        "Foster collaboration with integrated messaging and notification systems.",
    ...
    },
    {
      ...
      title: "Notifications",
      description:
        "Keep everyone informed with automated alerts and reminders.",
    ...
    },
    {
      ...
      title: "Customization",
      description:
        "Adapt the system to your institution's specific needs and workflows.",
