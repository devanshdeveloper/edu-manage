...
import { ArrowRight, CheckCircle, School, Users, BookOpen, TestTube2, CreditCard, Shield, Award, BarChart3 } from 'lucide-react';
...
export function LandingPage() {
  const features = [
    {
      ...
      description: "Efficiently manage student records, attendance, and academic progress tracking."
    },
    {
      icon: <BookOpen className="w-6 h-6 text-primary" />,
      title: "Course Management",
      description: "Create and manage courses, assignments, and learning materials."
    },
    {
      icon: <TestTube2 className="w-6 h-6 text-primary" />,
      title: "Online Testing",
      description: "Conduct online tests, quizzes, and assessments with automated grading."
    },
    {
      icon: <CreditCard className="w-6 h-6 text-primary" />,
      title: "Fee Management",
      description: "Handle fee collection, generate invoices, and track payments."
    },
    {
  ...
  const testimonials = [
    {
      quote: "This platform has revolutionized how we manage our institution. The automation and insights are invaluable.",
      author: "Dr. Sarah Wilson",
      role: "Principal, Springfield Academy",
      avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop"
    },
    {
      quote: "The student management and online testing features have made our processes so much more efficient.",
      author: "Prof. Michael Chen",
      role: "Director, Tech Institute",
      avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop"
    },
    {
      quote: "Outstanding support team and regular updates keep making the platform better and better.",
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-b from-primary-50 to-white dark:from-primary-900/20 dark:to-background">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-large text-default-600 mb-8">
                Streamline operations, enhance learning experiences, and drive growth with our comprehensive institute management system.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-default-600 max-w-2xl mx-auto">
              Our platform provides comprehensive tools and features to streamline your administrative tasks and enhance the learning experience.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-6">
                <CardBody className="gap-4">
                  <p className="text-default-600 italic">"{testimonial.quote}"</p>
