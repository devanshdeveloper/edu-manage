  ...
  const faqs = [
    {
      ...
      answer: "You can start using our platform immediately after signing up. Our onboarding team will help you set up everything within 24-48 hours."
    },
    {
      question: "What kind of support do you provide?",
      answer: "We offer 24/7 technical support via email, chat, and phone for our Professional and Enterprise plans. Basic plan includes email support during business hours."
    },
    {
      question: "Can we migrate data from our current system?",
      answer: "Yes! We provide comprehensive data migration services and tools to help you transition smoothly from your existing system."
    }
  ];
      ...
      <div className="bg-gradient-to-b from-primary-50 to-white dark:from-primary-900/20 dark:to-background py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-large text-default-600 max-w-2xl mx-auto">
            Have questions about our platform? Our team is here to help you find the perfect solution for your institution.
          </p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  <Select
                    ...
                    variant="bordered"
                    startContent={<HelpCircle className="w-4 h-4 text-default-400" />}
                  >
                ...
                <Card className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-small text-default-500">Chat with our team</p>
                    </div>
                  </div>
                </Card>
                <Card className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-small text-default-500">+1 (555) 123-4567</p>
                    </div>
                  </div>
                </Card>
              </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-small text-default-500">
                        Our technical support team is available around the clock for Professional and Enterprise plans.
                      </p>
                    </div>
                  </div>
                  <Divider />
                  <div>
                    <p className="font-semibold mb-2">Business Hours (Basic Plan)</p>
